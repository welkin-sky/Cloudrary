        ...
        Item{
            Row{
                ...
                FluFilledButton{
                    ...
                    horizontalPadding: 6
                    onClicked:{
                        showSuccess(JSON.stringify(dataObject)) //这里三个都要改，但我不知道改什么
                    }
                }
                FluFilledButton{
                    text:"收藏"
                    horizontalPadding: 6
                    onClicked:{
                        showInfo(JSON.stringify(dataObject))   //这里的两个JSON的我不知道在哪里
                    }
                }
                FluFilledButton{
                    text:"删除"
                    horizontalPadding: 6
                    onClicked:{
                        showError(JSON.stringify(dataObject))   //这里的两个JSON的我不知道在哪里
                    }
                }
