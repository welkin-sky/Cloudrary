...
int test() {
  ...
  auto showBook = [](const Book& a, const char name[]) {
    cout << name << ": " << a.getName() << '\t' << a.getTitle() << '\t'
         << a.getTextPath() << '\t' << a.getCoverPath() << '\t' << a.getAuthor()
         << '\t' << a.getDescription() << endl;
  };  // getter测试

  Book b1;  //默认初始化
  Book b2 = {"b2",       "Book 2",   "C:\\text_path2", "C:\\cover_path2",
             "Author 2", "List init"};  // 列表初始化
  Book b3 = b2;                         // 复制赋值，为深拷贝
  Book b4;
  Book b5(
      "{\"description\":\"Default initialization.\",\"author\":\"Author "
      "5\",\"coverPath\":\"C:\\\\"
      "coverPath5\",\"name\":\"b5\",\"textPath\":\"C:\\\\textPath5\",\"title\":"
      "\"Book 5\"}");  //从JSON初始化
  ...
  b1.setName("b1")
      .setTitle("Book 1")
      .setTextPath("C:\\somepath")
      .setCoverPath("C:\\another")
      .setAuthor("Author 1")
      .setDescription("Default init");  // setter测试
  showBook(b1, "b1");
  ...
  string json1 =
      "{\"description\":\"Default initialization.\",\"author\":\"Author "
      "4\",\"coverPath\":\"C:\\\\"
      "coverPath4\",\"name\":\"b4\",\"textPath\":\"C:\\\\textPath4\",\"title\":"
      "\"Book 4\"}";
  ...
  auto showBL = [](const BookList& bl, const char* name) {
    cout << name << ": ";
    for (const auto& b : bl) cout << b.getName() << '\t';
    cout << endl;
  };  // BookList可以使用基于范围的for语法
  ...
  cout << "l2[0] :" << l2[0].getName() << ", l2[1]: " << l2.at(1).getName()
       << endl;  // 按索引访问

  cout << "Index of b1 in l2:" << l2.find(b1)
       << endl;  // 按Book引用查找对应索引
  ...
  string json2 =
      "[{\"author\":\"Author "
      "2\",\"coverPath\":\"C:\\\\cover_path2\",\"description\":\"List init\","
      "\"name\":\"b2\",\"textPath\":\"C:\\\\text_path2\",\"title\":\"Book "
      "2\"},{\"author\":\"Author 2\","
      "\"coverPath\":\"C:\\\\cover_path2\",\"description\":\"List "
      "init\",\"name\":\"b3\","
